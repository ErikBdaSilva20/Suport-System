...
export const previewTickets: Ticket[] = [
  {
    ...
    number: 1,
    customer_id: 'cust-1',
    subject: 'Sistema de login não funciona',
    description: 'Após a atualização de ontem ninguém consegue acessar.',
    status: 'open',
    priority: 'high',
    assigned_to: null,
    resolved_at: null,
  ...
  },
  {
    ...
    description: 'Como faço para integrar com a API REST?',
    status: 'in_progress',
    priority: 'medium',
